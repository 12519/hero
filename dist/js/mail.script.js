...
////////////////////////////// Quill Editor ////////////////////////
	...
	if ($("#snow-container-1").length > 0)
    {
        var quill = new Quill('#snow-container-1', {
            placeholder: 'Compose an epic...',
            theme: 'snow'
        });
    }
	
	if ($("#snow-container-2").length > 0)
    {
        var quill = new Quill('#snow-container-2', {
            placeholder: 'Compose an epic...',
            theme: 'snow'
        });
    }
	
	if ($("#snow-container-3").length > 0)
    {
        var quill = new Quill('#snow-container-3', {
            placeholder: 'Compose an epic...',
            theme: 'snow'
        });
    }
