...
(function (Z, M) {
		...
		u = function () {
			...
			u.prototype.brighten = function (a) {
				...
				if (this.stops) this.stops.forEach(function (n) {
					...
					for (var q = 0; 3 > q; q++) A[q] += y(255 * a), 0 > A[q] && (A[q] = 0), 255 < A[q] && (A[q] = 255);
				return this
			};
	...
	M(a, "Core/Color/Palettes.js", [], function () {
		return {
			//colors: "#3898b6 #1b3d62 #90ed7d #f7a35c #8085e9 #f15c80 #e4d354 #2b908f #f45b5b #91e8e1".split(" ")
			colors: "#3898b6 #1b3d62".split(" ")
		}
	});
		...
		a = function () {
			...
			a.prototype.trimTicks = function (b, d, a) {
				...
				if (!this.isLinked) {
					if (d && -Infinity !== c) this.min = c;
						...
						for (; this.min - g > b[0];) b.shift(); if (a) this.max = e;
					else
			...
			a.prototype.adjustTickAmount = function () {
				...
				if (this.hasData() && g(this.min) && g(this.max)) {
					...
					} else m > c && (this.tickInterval *= 2, this.setTickPositions()); if (p(e)) {
					...
					if (n && v > n)
						...
						if (t)
							if (x.length === t)
								...
								for (c = 0; c < v; c++) d = a[c], r[c] = d[0], E[c] = d.slice(1, t + 1);
	...
	M(a, "Series/Pie/PieDataLabel.js", [a["Core/Series/DataLabel.js"],
		...
		(function (f) {
			...
			f.compose = function (c) {
				a.compose(A); - 1 === w.indexOf(c) && (w.push(c), c = c.prototype, c.dataLabelPositioners = C, c.alignDataLabel = v, c.drawDataLabels = p, c.placeDataLabels = u, c.verifyDataLabelOverflow = t)
			}
		})(f || (f = {}));
		return f
	});
					...
					function c(a, f, h, k) {
						...
						H(a, function (a, d) {
							if (!k && -1 < e.collectionsWithUpdate.indexOf(d) && f[d])
								for (a = q(a), h[d] = [], b = 0; b < Math.max(a.length, f[d].length); b++) f[d][b] && (void 0 === a[b] ? h[d][b] = f[d][b] : (h[d][b] = {}, c(a[b], f[d][b], h[d][b], k + 1)));
