...
/////////////////////////////////// Bar Chart /////////////////////
    ...
    var chartjs_other_pie = document.getElementById("chartjs-other-pie1");
    if (chartjs_other_pie) {
        var ctx = document.getElementById('chartjs-other-pie1').getContext('2d');
        window.myDoughnut = new Chart(ctx, config11);
    }

    var chartjs_other_pie = document.getElementById("chartjs-other-pie11");
    if (chartjs_other_pie) {
        var ctx = document.getElementById('chartjs-other-pie11').getContext('2d');
        window.myDoughnut = new Chart(ctx, config22);
    }

    var chartjs_other_pie2 = document.getElementById("chartjs-other-ticket");
    if (chartjs_other_pie) {
        var ctx = document.getElementById('chartjs-other-ticket').getContext('2d');
        window.myDoughnut = new Chart(ctx, config2);
    }
	
	var chartjs_other_pie3 = document.getElementById("chartjs-other-ticket3");
    if (chartjs_other_pie3) {
        var ctx = document.getElementById('chartjs-other-ticket3').getContext('2d');
        window.myDoughnut = new Chart(ctx, config3);
    }
	
	var chartjs_other_pie4 = document.getElementById("chartjs-other-ticket4");
    if (chartjs_other_pie4) {
        var ctx = document.getElementById('chartjs-other-ticket4').getContext('2d');
...
/////////////////////////////////// Analytic Chart /////////////////////
    if ($("#apex_crypto_chart_2").length > 0)
    {
        options = {
            theme: {
                mode: theme
        ...
        var chart = new ApexCharts(
                document.querySelector("#apex_crypto_chart_2"),
                options
                );
        chart.render();
    }
...
/////////////////////////////////// Start /////////////////////
        ...
        title: {
          // text: 'Monthly Leads Coversion Statics',
          align: 'left'
        },
        grid: {
          row: {
        ...
        xaxis: {
          categories: ['First Week 1-7', 'Second Week 8-14', 'Third Week 15-21', 'Forth Week 22-31'],
        }
        };

        var chart = new ApexCharts(document.querySelector("#chartxxx"), options);
        chart.render();
